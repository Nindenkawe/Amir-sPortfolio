          ...
          chartOptions: {
            ...
            plotOptions: {
              bar: {
                horizontal: true,
                isDumbbell: true,
                dumbbellColors: [['#00FF00', '#0000FF']]
              }
            },
            title: {
              text: 'Trend of international internet bandwidth (Mbps) from Q4 2021 to Q4 2022'
            },
            legend: {
              show: true,
              ...
              customLegendItems: ['Equipped bandwidth', 'Used bandwidth']
            },
            fill: {
              type: 'gradient',
              gradient: {
