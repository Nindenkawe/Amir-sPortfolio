  ...
  <div class="col-span-2">
    <div data-bs-spy="scroll" data-bs-target="#scrollspy1" data-bs-offset="200" class="scrollspy-example">
      <section id="Generalstats">
        ...
        <br>
        <p class="flex-shrink-0 text-2xl mx-auto p-2  border border-purple-700 text-gray-500 dark:text-black-400 rounded-lg shadow-md" v-show="activeTab === 'srp' || activeTab === 'srp'">
        ...
        <p class="flex-shrink-0 text-2xl mx-auto p-2  border border-green-700 text-gray-500 dark:text-black-400 rounded-lg shadow-md" v-show="activeTab === 'gdp'">
        ...
        <p class="flex-shrink-0 text-2xl mx-auto p-2 border border-yellow-400 text-gray-500 dark:text-black-400 rounded-lg shadow-md" v-show="activeTab === 'cpi'">
        ...
        <p class="flex-shrink-0 text-2xl mx-auto p-2  border border-blue-700 text-gray-500 dark:text-black-400 rounded-lg shadow-md" v-show="activeTab === 'life'">
      ...
      <section id="price index by Region">
        ...
        <p class="flex-shrink-0 text-2xl mx-auto p-2  border-gray-200 dark:border-gray-700 text-gray-500 dark:text-black-400 rounded-lg shadow-md">
      ...
      <section id="Telecommunications">
        ...
        <p class="flex-shrink-0 text-2xl mx-auto p-2  border-gray-200 dark:border-gray-700 text-gray-500 dark:text-black-400 shadow-md">
          ...
          <table class="table-auto w-full flex-shrink-0 text-2xl mx-auto p-2  border-gray-200 dark:border-gray-700 text-gray-500 dark:text-black-400 shadow-md">
            <thead>
              <tr>
