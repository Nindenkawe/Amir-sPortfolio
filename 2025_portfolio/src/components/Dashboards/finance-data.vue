      ...
      <div class="bg-blue-dark">
        <div class="container mx-auto px-4">
          <div class="flex items-center md:justify-between py-4">
            ...
            <div class="w-1/2 md:w-auto text-center text-white text-2xl font-medium">cointoad</div>
      ...
      <div class="bg-white border-t border-b sm:border-l sm:border-r sm:rounded shadow mb-6">
        <div class="border-b px-6">
          <div class="flex justify-between -mb-px">
            <div class="lg:hidden text-blue-dark py-4 text-lg">Price Charts</div>
        ...
        <div class="flex items-center px-6 lg:hidden">
          <div class="flex-grow flex-no-shrink py-6">
            ...
            <div class="text-green-light text-sm">&uarr; CA$12,955.35 (154.16%)</div>
          </div>
        ...
        <div class="hidden lg:flex">
          <div class="w-1/3 text-center py-8">
            <div class="border-r">
              ...
              <div class="text-sm uppercase text-grey tracking-wide">Bitcoin Price</div>
            </div>
          </div>
          <div class="w-1/3 text-center py-8">
            <div class="border-r">
              ...
              <div class="text-sm uppercase text-grey tracking-wide">Since last month (CAD)</div>
            </div>
          </div>
          <div class="w-1/3 text-center py-8">
            <div>
              ...
              <div class="text-sm uppercase text-grey tracking-wide">Since last month (%)</div>
            </div>
          </div>
        </div>
      </div>
